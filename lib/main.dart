...
void main() async {
  ...
  try {
    ...
    print('✅ Supabase initialized in main()');
  } catch (e) {
    print('❌ Failed to initialize Supabase: $e');
  }

  print('Coffee House App Ready!');
