...
class CoffeeProductsScreen extends StatefulWidget {
  const CoffeeProductsScreen({Key? key}) : super(key: key);

  @override
  State<CoffeeProductsScreen> createState() => _CoffeeProductsScreenState();
}

class _CoffeeProductsScreenState extends State<CoffeeProductsScreen> {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              // Navigate to All Products screen when selected
                              if (index == 0) {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                ...
                                // Already on COFFEE, just keep current state
                                return;
                              }
                            },
                            child: Container(
...
// Reuse the same ProductDetailModal from all_products.dart
